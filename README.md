...
- You want it to drop content immediately when strong reference count goes 0. (Collecting a deep structure drops layer-by-layer, so it may take long time to fully drop.)
